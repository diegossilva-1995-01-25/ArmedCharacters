...
public class TelaPersonagem extends Tela implements ActionListener, ListSelectionListener {
	 ...
	 * Create the frame.
	 */
	public TelaPersonagem(String senha) {
		pass = senha;
		...
		controlePersonagem = new CtrPersonagem(pass);
		...
		controlePersonagem.consultarPersonagem("");
		atualizarTabela();
	...
	public Personagem telaParaPersonagem(Personagem p) {
		...
		try {
			...
			p.setObra(Integer.parseInt(txtObra.getText()));
	...
	public void personagemParaTela(Personagem p) {
		...
		txtObra.setText(String.valueOf(p.getObra()));
	}
