...
public class PanelObraEscrita extends PanelAbstrato implements ActionListener, ListSelectionListener {
	 ...
	 * Create the panel.
	 */
	public PanelObraEscrita(Obra o) {
		...
		controleObraEscrita.consultarObraEscrita(to.txtTitulo.getText());
		atualizarTabela();
	...
	public ObraEscrita telaParaObraEscrita(ObraEscrita oE) {
		oE.setId(obra.getId());
		oE.setTitulo(obra.getTitulo());
		oE.setAno(obra.getAno());
		oE.setGenero(obra.getGenero());
